...
public class Config {
	...
	public static ArrayList<Progress> getProgress() {
		if (mProgresses == null) {
			...
			Course c2_2 = new Course(R.drawable.course01, Config.CourseData2_2);
			Course c2_3 = new Course(R.drawable.course01, Config.CourseData2_3);
			Course c3_1 = new Course(R.drawable.course01, Config.CourseData3_1);
			Course c3_2 = new Course(R.drawable.course01, Config.CourseData3_2);
			Course c3_3 = new Course(R.drawable.course01, Config.CourseData3_3);
			Course c4_1 = new Course(R.drawable.course01, Config.CourseData4_1);
			Course c4_2 = new Course(R.drawable.course01, Config.CourseData4_2);
			Course c4_3 = new Course(R.drawable.course01, Config.CourseData4_3);
			Course c5_1 = new Course(R.drawable.course01, Config.CourseData5_1);
			Course c5_2 = new Course(R.drawable.course01, Config.CourseData5_2);
			Course c5_3 = new Course(R.drawable.course01, Config.CourseData5_3);
			Course c6_1 = new Course(R.drawable.course01, Config.CourseData6_1);
			Course c6_2 = new Course(R.drawable.course01, Config.CourseData6_2);
			Course c6_3 = new Course(R.drawable.course01, Config.CourseData6_3);
			Course c7_1 = new Course(R.drawable.course01, Config.CourseData7_1);
			Course c7_2 = new Course(R.drawable.course01, Config.CourseData7_2);
			Course c7_3 = new Course(R.drawable.course01, Config.CourseData7_3);
			Course c8_1 = new Course(R.drawable.course01, Config.CourseData8_1);
			Course c8_2 = new Course(R.drawable.course01, Config.CourseData8_2);
			Course c8_3 = new Course(R.drawable.course01, Config.CourseData8_3);
			Course c9_1 = new Course(R.drawable.course01, Config.CourseData9_1);
			Course c9_2 = new Course(R.drawable.course01, Config.CourseData9_2);
			Course c9_3 = new Course(R.drawable.course01, Config.CourseData9_3);
			Course c10_1 = new Course(R.drawable.course01, Config.CourseData10_1);
			Course c10_2 = new Course(R.drawable.course01, Config.CourseData10_2);
			Course c10_3 = new Course(R.drawable.course01, Config.CourseData10_3);
			Course c11_1 = new Course(R.drawable.course01, Config.CourseData11_1);
			Course c11_2 = new Course(R.drawable.course01, Config.CourseData11_2);
			Course c11_3 = new Course(R.drawable.course01, Config.CourseData11_3);
			Course c12_1 = new Course(R.drawable.course01, Config.CourseData12_1);
			Course c12_2 = new Course(R.drawable.course01, Config.CourseData12_2);
			Course c12_3 = new Course(R.drawable.course01, Config.CourseData12_3);
			Course c13_1 = new Course(R.drawable.course01, Config.CourseData13_1);
			Course c13_2 = new Course(R.drawable.course01, Config.CourseData13_2);
			Course c13_3 = new Course(R.drawable.course01, Config.CourseData13_3);
			Course c14_1 = new Course(R.drawable.course01, Config.CourseData14_1);
			Course c14_2 = new Course(R.drawable.course01, Config.CourseData14_2);
			Course c14_3 = new Course(R.drawable.course01, Config.CourseData14_3);
