...
public class Config {
	...
	public static final HashMap<String, Integer> mSoundMap = new HashMap<String, Integer>() {
		...
		put("29_e", R.raw.sound029_e);
		put("30_e", R.raw.sound030_e);
		put("31_e", R.raw.sound031_e);
		put("33_e", R.raw.sound033_e);
		put("36_e", R.raw.sound036_e);
		put("37_e", R.raw.sound037_e);
		put("40_e", R.raw.sound040_e);
		put("42_e", R.raw.sound042_e);
		put("50_e", R.raw.sound050_e);
		put("51_e", R.raw.sound051_e);
		put("58_e", R.raw.sound058_e);
		put("59_e", R.raw.sound059_e);
		put("60_e", R.raw.sound060_e);
		put("62_e", R.raw.sound062_e);
	...
	public static final HashMap<String, Integer> mImageMap = new HashMap<String, Integer>() {
		...
		put("24", R.drawable.red24);
		put("28", R.drawable.red28);
		put("29", R.drawable.red29);
		put("30", R.drawable.red30);
		put("31", R.drawable.red31);
		put("33", R.drawable.red33);
		put("36", R.drawable.red36);
		put("37", R.drawable.red37);
		put("40", R.drawable.red40);
		put("42", R.drawable.red42);
		put("50", R.drawable.red50);
		put("51", R.drawable.red51);
		put("58", R.drawable.red58);
		put("59", R.drawable.red59);
		put("60", R.drawable.red60);
		put("62", R.drawable.red62);
		...
		put("24_e", R.drawable.red24);
		put("28_e", R.drawable.red28);
		put("29_e", R.drawable.red29);
		put("30_e", R.drawable.red30);
		put("31_e", R.drawable.red31);
		put("33_e", R.drawable.red33);
		put("36_e", R.drawable.red36);
		put("37_e", R.drawable.red37);
		put("40_e", R.drawable.red40);
		put("42_e", R.drawable.red42);
		put("50_e", R.drawable.red50);
		put("51_e", R.drawable.red51);
		put("58_e", R.drawable.red58);
		put("59_e", R.drawable.red59);
		put("60_e", R.drawable.red60);
		put("62_e", R.drawable.red62);
